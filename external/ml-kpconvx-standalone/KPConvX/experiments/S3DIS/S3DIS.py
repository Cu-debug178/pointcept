...
#
#   This is the legacy full area dataset used in the original KPConv paper. We recommend using S3DIS_rooms.py.
#
#
...
#
#   KPConvX project: S3DIS.py
#       > Legacy dataset class for the old S3DIS (Areas are not split in rooms)
#


def S3DIS_cfg(cfg, dataset_path='../data/S3DIS'):
