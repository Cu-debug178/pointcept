...
#
#   KPConvX project: ScanObjectNN.py
#       > Dataset class for ScanObjectNN
#
...
from data_handlers.object_classification import ObjClassifDataset
...
def ScanObjectNN_cfg(cfg, dataset_path='../data/ScanObjectNN/main_split'):
